...
var file_proto_wecom_wecom_rpc_proto_rawDesc = []byte{
	...
	0x66, 0x2e, 0x41, 0x6e, 0x79, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x32, 0xa7, 0x1d, 0x0a,
...
var file_proto_wecom_wecom_rpc_proto_depIdxs = []int32{
	...
	13, // 71: wrpc.WecomRPC.GetUserList:output_type -> wrpc.ResponseVO
	13, // 72: wrpc.WecomRPC.GetUserInfo:output_type -> wrpc.ResponseVO
	13, // 73: wrpc.WecomRPC.SaveUserDetail:output_type -> wrpc.ResponseVO
	13, // 74: wrpc.WecomRPC.GetUserDetailByUserID:output_type -> wrpc.ResponseVO
	13, // 75: wrpc.WecomRPC.GetUserDetailList:output_type -> wrpc.ResponseVO
	13, // 76: wrpc.WecomRPC.GetRoleList:output_type -> wrpc.ResponseVO
	13, // 77: wrpc.WecomRPC.GetRoleByUserID:output_type -> wrpc.ResponseVO
	13, // 78: wrpc.WecomRPC.GetUserByRoleName:output_type -> wrpc.ResponseVO
	13, // 79: wrpc.WecomRPC.FindCustomerList:output_type -> wrpc.ResponseVO
	13, // 80: wrpc.WecomRPC.FindCustomerGroupList:output_type -> wrpc.ResponseVO
	13, // 81: wrpc.WecomRPC.FindCustomerCouldBeSelectedList:output_type -> wrpc.ResponseVO
	13, // 82: wrpc.WecomRPC.AddCustomer:output_type -> wrpc.ResponseVO
	13, // 83: wrpc.WecomRPC.UpdateCustomerRemark:output_type -> wrpc.ResponseVO
	13, // 84: wrpc.WecomRPC.GetCustomerInRobotChat:output_type -> wrpc.ResponseVO
	13, // 85: wrpc.WecomRPC.GetCustomerGroup:output_type -> wrpc.ResponseVO
	13, // 86: wrpc.WecomRPC.GetCustomerGroupList:output_type -> wrpc.ResponseVO
	13, // 87: wrpc.WecomRPC.GetCustomerGroupChat:output_type -> wrpc.ResponseVO
	13, // 88: wrpc.WecomRPC.GetCustomerGroupChatByChatID:output_type -> wrpc.ResponseVO
	13, // 89: wrpc.WecomRPC.FlushCustomer:output_type -> wrpc.ResponseVO
	13, // 90: wrpc.WecomRPC.SyncCustomerGroup:output_type -> wrpc.ResponseVO
	13, // 91: wrpc.WecomRPC.FlushCustomerGroup:output_type -> wrpc.ResponseVO
	13, // 92: wrpc.WecomRPC.QueryCustomerGroupByCond:output_type -> wrpc.ResponseVO
	13, // 93: wrpc.WecomRPC.SendTextMsg:output_type -> wrpc.ResponseVO
	13, // 94: wrpc.WecomRPC.SendWarnMsg:output_type -> wrpc.ResponseVO
	13, // 95: wrpc.WecomRPC.FindAccountUserList:output_type -> wrpc.ResponseVO
	13, // 96: wrpc.WecomRPC.SyncAccountUser:output_type -> wrpc.ResponseVO
	13, // 97: wrpc.WecomRPC.FlushAccountUser:output_type -> wrpc.ResponseVO
	13, // 98: wrpc.WecomRPC.GetAccountUserList:output_type -> wrpc.ResponseVO
	13, // 99: wrpc.WecomRPC.GetAccountUserListByOpenIDList:output_type -> wrpc.ResponseVO
	13, // 100: wrpc.WecomRPC.ModifyAccountUserRemark:output_type -> wrpc.ResponseVO
	13, // 101: wrpc.WecomRPC.GetAccountTagList:output_type -> wrpc.ResponseVO
	13, // 102: wrpc.WecomRPC.GetOauthCallBackURL:output_type -> wrpc.ResponseVO
	13, // 103: wrpc.WecomRPC.SyncContactWayList:output_type -> wrpc.ResponseVO
	13, // 104: wrpc.WecomRPC.FlushContactWay:output_type -> wrpc.ResponseVO
	13, // 105: wrpc.WecomRPC.SendAccountTrackMsg:output_type -> wrpc.ResponseVO
	13, // 106: wrpc.WecomRPC.SendAccountProcMsg:output_type -> wrpc.ResponseVO
	13, // 107: wrpc.WecomRPC.QueryFieldList:output_type -> wrpc.ResponseVO
	13, // 108: wrpc.WecomRPC.FindSupplierList:output_type -> wrpc.ResponseVO
	13, // 109: wrpc.WecomRPC.SyncSupplier:output_type -> wrpc.ResponseVO
	13, // 110: wrpc.WecomRPC.FindBusinessCustomerList:output_type -> wrpc.ResponseVO
	13, // 111: wrpc.WecomRPC.SyncBusinessCustomer:output_type -> wrpc.ResponseVO
	13, // 112: wrpc.WecomRPC.UpdateBusinessCustomer:output_type -> wrpc.ResponseVO
	13, // 113: wrpc.WecomRPC.FindEnumList:output_type -> wrpc.ResponseVO
	13, // 114: wrpc.WecomRPC.QueryNameByType:output_type -> wrpc.ResponseVO
	13, // 115: wrpc.WecomRPC.GetBusinessCustomer:output_type -> wrpc.ResponseVO
	13, // 116: wrpc.WecomRPC.GetNeedNotifyCustomerList:output_type -> wrpc.ResponseVO
	13, // 117: wrpc.WecomRPC.FindClaimedCustomer:output_type -> wrpc.ResponseVO
	13, // 118: wrpc.WecomRPC.SaveCustomerPointRecord:output_type -> wrpc.ResponseVO
	13, // 119: wrpc.WecomRPC.GetCustomerPointRecord:output_type -> wrpc.ResponseVO
	13, // 120: wrpc.WecomRPC.ListCustomerPointRecord:output_type -> wrpc.ResponseVO
	13, // 121: wrpc.WecomRPC.ListUserByCond:output_type -> wrpc.ResponseVO
	13, // 122: wrpc.WecomRPC.JudgeTodayIsWorkday:output_type -> wrpc.ResponseVO
	13, // 123: wrpc.WecomRPC.QueryIndicatorCount:output_type -> wrpc.ResponseVO
	13, // 124: wrpc.WecomRPC.QueryIndicatorDetail:output_type -> wrpc.ResponseVO
	13, // 125: wrpc.WecomRPC.QueryHalfDayLeaveMap:output_type -> wrpc.ResponseVO
	13, // 126: wrpc.WecomRPC.QueryCheckInMonth:output_type -> wrpc.ResponseVO
	...
	13, // 131: wrpc.WecomRPC.SyncKnowledgeBase:output_type -> wrpc.ResponseVO
	13, // 132: wrpc.WecomRPC.QueryIndicatorCountInBatch:output_type -> wrpc.ResponseVO
	71, // [71:133] is the sub-list for method output_type
	9,  // [9:71] is the sub-list for method input_type
